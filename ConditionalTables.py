                ...
                for outleval in product(range(UniqnDiscretiseO), repeat=1):
                    for inleval in product(range(nDiscretise), repeat=nEdges):
                        ...
                        for index11 in range(0, nEdges, 1):
                            if inleval[index11]>=UniqnDiscretise[index11]:
                                Correct=0
                        if Correct==1:
                            lst_dic1 = []
                            lst_dic2 = []
                            ...
                            for sample_run in range(OverallSample):
                                LenselDatasimrun=[]
                                for index11 in range(0, nEdges, 1):
                                    selDatasimrun = DataFrameForDisLay1Input[(DataFrameForDisLay1Input["sample_run"] == sample_run)&(DataFrameForDisLay1Input['Edge']==AllEdges[edge])&(DataFrameForDisLay1Input[MeasureI00]==inleval[index11])]
                            ...
                            keys=['DepenVar', 'DepenVarLvel', 'IndepenVar','IndepenVarLvel',
                                  'IndepenVar1', 'IndepenVar1Lvel','IndepenVar2', 'IndepenVar2Lvel','IndepenVar3', 'IndepenVar3Lvel', 'CondProb']
