...
Conditional_prob <- function(cond11, path_string, file_extensions,max_i_index,min_i_index){
  ...
  assign(as.vector(paste('result_inf1',sep="")),eval(parse(text=paste("replicate (100,cpquery(bn11, event =  ",cond11,"  , evidence = ( (",bridge1_str," == 1) & (",bridge2_str," == 1) & (",bridge3_str," == 1) & (",bridge4_str," == 1) & (",bridge5_str," == 1)),n=1000))"))) )
...
#return(c(min_i_index,max_i_index))  
}

Min_max_index<-Conditional_prob("(TravelTimeDisc11 == 1) | (TravelTimeDisc11 == 2)","C:\\Users\\Mohsen\\Documents\\PythonProjects\\Opac\\OutputResults29June2023V75disc5\\", "Time12",11456,9811)

Min_max_index<-Conditional_prob("(TravelTimeDisc11 == 0) | (TravelTimeDisc11 == 1)","C:\\Users\\Mohsen\\Documents\\PythonProjects\\Opac\\OutputResults29June2023V75disc5\\", "Time01",14857,521)

Min_max_index<-Conditional_prob("(TotalCostDisc11 == 1) | (TotalCostDisc11 == 2)","C:\\Users\\Mohsen\\Documents\\PythonProjects\\Opac\\OutputResults29June2023V75disc5\\", "Cost12",2822,13100)

Min_max_index<-Conditional_prob("(TotalCostDisc11 == 0) | (TotalCostDisc11 == 1)","C:\\Users\\Mohsen\\Documents\\PythonProjects\\Opac\\OutputResults29June2023V75disc5\\", "Cost01",8785,4974)
