...
#setwd("~/2019-05-30-NKJavad-NewRajab/Eindhoven-research/2021-01-01-FinalSelected/future-2/Case-data-02-FinalPythonCodeResults/20210820-Alg3Results/DiscretizeAlg1")

#setwd("~/2019-05-30-NKJavad-NewRajab/Eindhoven-research/2021-01-01-FinalSelected/future-2/Case-data-04/DiscretizeAlg1")
setwd("C:/Users/20204066/Box/RESS-format/2022-04-08-ESREL2022/20220421ResultsV04")
getwd()
...
CondiProbTableLevels21 <- read.csv('2022-04-01-CondiProbTableLevels21.csv',sep = ",",2)                                                                             
View(CondiProbTableLevels21)
DFCondiProbTableLevels21 = data.frame(CondiProbTableLevels21)
DFCondiProbTableLevels21$DepenVar


CondiProbTableLevels10 <- read.csv('2022-04-01-CondiProbTableLevels10.csv',sep = ",",2)                                                                             
