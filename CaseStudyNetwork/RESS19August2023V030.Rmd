...
result_inf1<-replicate (100,cpquery(bn11, event =  (TravelTimeDisc11 == 1) | (TravelTimeDisc11 == 0)  , evidence = ( (Bridge0Road13 == 1) & (Bridge0Road49 == 1) & (Bridge0Road57 == 1) & (Bridge0Road63 == 1)),n=10000))
summary(result_inf1)
...
reso <- 500
#length <- 2*reso/72
png("test13.png",10, 8, units="in",res=1000) #,height=length,width=length)
