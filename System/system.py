...
class SystemAll():
    ...
    def Sampling4InputAlg3(self, resultsPath,pdAlg2SubnetLevel,pdAlg3InputSample,MeasureList,Subnet,OverallSample,PlotDist,n_sample):
        ...
        if PlotDist == 1:
            for jjj in range(0, 2, 1):
                ...
                ax2.hist(pdAlg3InputSample[Measure], cumulative=1, histtype='step', bins=100, color='tab:orange', density=True)
    ...
    def SimulateCostAlg3(self, network_instance, pdAlg3InputSampleConCat, pdAlg3OutputConCat, OverallSample):
        ...
        for sample_run in range(OverallSample):  # OverallSample
            ...
            for Subnet in range(1, 5, 1):
                selDataCostSubnet = pdAlg3InputSampleConCat.loc[
                    (pdAlg3InputSampleConCat["sample_run"] == sample_run) & (pdAlg3InputSampleConCat["subnetwork"] == Subnet)]
            ...
            lowerexp = 0
            term2 = truncexpon.rvs(b=selDataCostEdgeValAveragedAcrossRunsMin * final_term, loc=lowerexp, scale=1 / final_term)
            term1 = term - term2

            lst_dic1.append({'sample_run': sample_run, 'TravelTime': 1.0, 'TotalCost': term1})
