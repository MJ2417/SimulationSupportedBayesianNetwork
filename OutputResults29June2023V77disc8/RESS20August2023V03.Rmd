...
reso <- 500
#length <- 2*reso/72
#png("C:\\Users\\Mohsen\\Documents\\PythonProjects\\Opac\\OutputResults29June2023V77disc8\\MarginalDisFromRV012.png",10, 8, units="in",res=1000) #,height=length,width=length)

pdf("C:\\Users\\Mohsen\\Documents\\PythonProjects\\Opac\\OutputResults29June2023V77disc8\\MarginalDisFromRV012.pdf",width = 28, height = 28) #,height=length,width=length)
